        ...
        return (
            <ScrollView showsVerticalScrollIndicator={false} >
                <View style={styles.container}>
                    <Image resizeMode={'stretch'} style={{ width: "90%", height: "50%", marginTop: "30%", borderRadius: 100, margin: 30 }} source={require('../assets/images/logo.jpg')} />
                    <View style={{ padding: 10, flexDirection: 'column', justifyContent: 'center', }}>
                        <Text style={{ alignSelf: 'center', fontSize: 35, fontWeight: 'bold' }}>Enter Your Moble Number</Text>
                        <Text style={{ alignSelf: 'center', color: '#b2beb5', fontSize: 19 }}>If you have </Text>
                    </View>
